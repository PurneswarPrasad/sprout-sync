      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-green-600 rounded-2xl flex items-center justify-center shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-4xl mx-auto">
          <div className="text-center p-6 bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20">
            ...
            <p className="text-gray-600">Never miss a watering or feeding with personalized care reminders</p>
          </div>
          ...
          <div className="text-center p-6 bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Plant Identification</h3>
            <p className="text-gray-600">Identify unknown plants and get expert care tips instantly</p>
          </div>
          ...
          <div className="text-center p-6 bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20">
            ...
            <p className="text-gray-600">Monitor your plants' progress and celebrate their milestones</p>
          </div>
        </div>
