...
exports.getAlternativeNotificationMessage = exports.getNotificationMessage = void 0;
const getNotificationMessage = (plantName, taskKey, persona) => {
...
const getAlternativeNotificationMessage = (plantName, taskKey, persona, variation = 0) => {
    const alternativeMessages = alternativeNotificationTemplates[taskKey];
    if (!alternativeMessages) {
        return (0, exports.getNotificationMessage)(plantName, taskKey, persona);
    }
...
exports.getAlternativeNotificationMessage = getAlternativeNotificationMessage;
const alternativeNotificationTemplates = {
    watering: {
        PRIMARY: [
            {
